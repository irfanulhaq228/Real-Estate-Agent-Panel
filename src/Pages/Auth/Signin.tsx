    ...
    <div className="auth min-h-full">
      <div className="secondary-auth flex flex-col md:flex-row justify-between w-[90%] lg:w-[80%] xl:w-[1000px] gap-[80px] md:gap-0">
        <div className="flex-1 flex items-center justify-center md:border-e md:border-[var(--text-color-dark)] flex-col gap-5">
          <p className="text-white font-[700] text-[30px] text-center">
            Real Estate
          </p>
          <p className="text-gray-500 font-[600]">
            Sign-in yourself as an Agent
          </p>
          <FaHandPointRight className="hidden md:block text-[70px] text-[var(--text-color-dark)]" />
          <p className="hidden md:block text-gray-500 font-[600]">
            Don't Have Account ?{" "}
            <span
              className="text-[var(--text-color-dark)] cursor-pointer"
        ...
        <div className="flex-1 flex items-center justify-center flex-col gap-5">
          ...
          <div className="w-[100%] sm:w-[70%] flex flex-col gap-2">
            <label className="text-[13px] text-[var(--text-color-dark)] font-[500]">
              Email Address
            </label>
            <input
          ...
          {!loader ? (
            <button
              className="px-4 h-[40px] rounded-[8px] bg-[var(--sidebar-color)] text-white font-[600] text-[14px]"
              onClick={fn_Submit}
            >
              Submit
            </button>
            ...
            <button
              className="cursor-not-allowed px-4 h-[40px] rounded-[8px] bg-[var(--sidebar-color)] text-white font-[600] text-[14px]"
              disabled
            >
              Loading...
            </button>
          )}
          <p className="block md:hidden text-gray-500 font-[600]">
            Don't Have Account ?{" "}
            <span
              className="text-[var(--text-color-dark)] cursor-pointer"
              onClick={() => navigate("/sign-up")}
