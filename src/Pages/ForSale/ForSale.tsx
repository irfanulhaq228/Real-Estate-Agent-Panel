  ...
  return (
    <div className="get-for-rent">
      ...
      <div className="m-5 flex flex-col sm:flex-row justify-between items-center gap-3">
        ...
        <p className={`font-[600] text-[14px] cursor-pointer px-[15px] bg-[var(--table-heading-bg)] h-[40px] flex items-center rounded ${darkMode && "text-[var(--text-color-dark)]"}`} onClick={() => navigate("/sell-homes/create")}>
